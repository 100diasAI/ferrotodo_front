...
export default function Products() {
  ...
  const columnas = [
    {
      name: 'Nombre',
      selector: row => row?.nombre?.trim() || 'Sin nombre',
      sortable: true,
      grow: 0.2,
    },
    {
      name: 'Precio $',
      selector: row => row?.precio ?? 'N/A',
      sortable: true,
      grow: 0.1,
    },
    {
      name: 'Medidas',
      selector: row => row?.medidas || 'N/A',
      sortable: true,
      grow: 0.2,
    },
    {
    ...
    {
      name: 'Categoria',
      selector: row => row?.categorium?.nombre || 'Sin categoría',
      sortable: true,
      grow: 0.1,
    },
    {
      name: 'Marca',
      selector: row => row?.marca || 'Sin marca',
      sortable: true,
      grow: 0.1,
    },
    {
