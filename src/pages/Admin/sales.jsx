...
export default function Sales() {
  ...
  const columnas = [
    ...
    {
      name: 'Productos',
      selector: row => row.productos && row.productos.length > 0 ? row.productos[0].nombre : 'N/A',
      sortable: true,
      grow: 1.8
    },
    {
      name: 'Cantidad',
      selector: row => row.productos && row.productos.length > 0 && row.productos[0].compra ? row.productos[0].compra.cantidad : 'N/A',
      sortable: true,
      grow: 0.6,
    },
    {
